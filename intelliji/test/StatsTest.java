...
public class StatsTest
{
    ...
    public void basicsTest()
    {
        ...
        assertEquals("Species has to be equal to Acropora digitifera", "Acropora digitifera", this.results.getSpecies());
        assertEquals("Chromosome name has to be equal to NW_015441057", "NW_015441057", this.results.getChromosomeName());
    }
